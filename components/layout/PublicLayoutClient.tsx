    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-x-hidden">
      ...
      <div className="hidden md:flex flex-col min-h-screen" suppressHydrationWarning>
        ...
        <motion.header
          ...
          className="fixed top-0 left-0 right-0 z-50 border-b-2 border-border bg-card/95 backdrop-blur-md shadow-md h-16"
        >
      ...
      <div className="flex md:hidden flex-col min-h-screen" suppressHydrationWarning>
        <header className="fixed top-0 left-0 right-0 z-50 border-b-2 border-border bg-background/95 backdrop-blur-md shadow-md h-16">
